...
void Bullet::hitTarget()
{
    ...
    foreach(Enemy* attack_enemy, b_game->getEnemyList()){
        ...
        if(collisionWithCircle(attack_enemy->getPos(),b_tower->get_attackGroupRange(),b_targetPos,2)){
...
Frozen_Bullet::Frozen_Bullet(QPoint startPos,QPoint targetPos,Defend_Tower* tower,MainWindow * game,int time):
    Bullet(startPos,targetPos,tower,game)
{
    b_FrozenTime = time;
